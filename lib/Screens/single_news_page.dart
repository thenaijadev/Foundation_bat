// ignore_for_file: prefer_const_constructors, prefer_const_constructors_in_immutables, library_private_types_in_public_api, deprecated_member_use
                        ...
                        child: ClipRRect(
                            ...
                            child: CarouselSlider(
                                ...
                                items: widget.singleNews.files!.map((newsFile) {
                                  ...
                                  return Videos(
                                    thumbnailUrl: newsFile.thumbnail,
                                    videoUrl: newsFile.fileUrl,
                                  );
                                }).toList())),
                      ),
                      Row(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5,),
                      if(widget.singleNews.newsImage.isNotEmpty && widget.singleNews.newsImage != null)
                      RichText(
